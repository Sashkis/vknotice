...
Date.prototype.toStringVkFormat = function () {
	...
	else if(ago < 60) return getCase(Math.floor(ago), window.pop.i18n.date.seconds) + '&nbsp' + window.pop.i18n.date.ago;
	else if(ago < 3600) return getCase(Math.floor(ago / 60), window.pop.i18n.date.minutes) + '&nbsp' + window.pop.i18n.date.ago
	else if(ago < 10800) return getCase(Math.floor(ago / 3600), window.pop.i18n.date.hours) + '&nbsp' + window.pop.i18n.date.ago
	else {
