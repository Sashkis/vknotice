...
function Dialog (dialog_obj) {
	...
	this.construct = function () {
		...
		this.jQ.html( (this.addHeader() + '<div class="ans"><textarea></textarea></div>').icon('chat history slide', {'data-target': '#history'}).icon('ok markAsRead', {title: window.Popup.loc('Mark as read')}) );
		this.jQ.data(this);
		return this.jQ;
	};
